...
$LANG = array (
    ...
    'admin_setting_enable_delete_after_consultation_tip' => 'When enabled, item creators can decide whether a password item will be automatically deleted after a limited number of views.</span>',
    ...
    'admin_script_backup_decrypt_tip' => 'To decrypt an existing backup file in the upload folder, input the name with no extension and no path.',
    ...
    'enable_favourites' => 'Favourites bookmark feature enabled',
    ...
    'admin_email_server_url_tip' => 'Links are inserted into some emails back to the password manager site. You can change the URL (web address) that is used. Leave blank to use the URL automatically derived from your site settings.',
